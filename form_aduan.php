...
<form class="row g-3" method="POST" action="<?= base_url('masyarakat/simpan_aduan') ?>" enctype="multipart/form-data">
    ...
    <div class="col-12">
        <button type="submit" class="btn btn-success" onclick="return confirm('Apakah Anda Yakin Ingin Mengirim Pengaduan Ini?, Silahkan Cek terlebih Dahulu')">Tambah Aduan</button>
    </div>
</form>